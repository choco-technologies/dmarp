...
dmod_dmarp_api_declaration(1.0, dmarp_t, _create, ( void ))
{
    ...
    struct dmarp *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmarp_api_declaration(1.0, void, _destroy, ( dmarp_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmarp_api_declaration(1.0, bool, _is_valid, ( dmarp_t handle ))
{
